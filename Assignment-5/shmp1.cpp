...
/*office hours wed Dec 11: 10:30 - 12:30. Monday 10:30 - 12:30*/
using namespace std;
    ...
    for (i = 0; i < NCHILD; i++) { //creating NCHILD amount of processes
        ...
        switch (child[i]) {
            ...
            case 0: //successful creation of child process
                ...
                execl("shmc1", pname, ascshmid,SNAME, (char *)0); //replaces the program code with shmc1 and passes the pname and the PID as the arguments
